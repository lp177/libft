...
UT_TEST(ft_memccpy)
{
	...
	ft_putstr("\ndest:");ft_putstr(buf2);ft_putstr("\nsrc:");ft_putstr(buf1);
	ft_putstr("\nft:");ft_putstr(ft_memccpy(buf2, buf1, 0, sizeof(buf1)));
	ft_putstr("\nsys:");ft_putstr(memccpy(buf2, buf1, 0, sizeof(buf1)));*/
...
UT_TEST(ft_isascii)
{
	...
	UT_ASSERT_EQ(ft_isascii(0), 1);
	UT_ASSERT_EQ(ft_isascii(100), 1);
	UT_ASSERT_EQ(ft_isascii(127), 1);
	UT_ASSERT_EQ(ft_isascii(128), 0);
	UT_ASSERT_EQ(ft_isascii(200), 0);
}

UT_TEST(ft_isprint)
{
	UT_ASSERT_EQ(ft_isprint(31), 0);
	UT_ASSERT_EQ(ft_isprint(40), 1);
	UT_ASSERT_EQ(ft_isprint(64), 1);
	UT_ASSERT_EQ(ft_isprint(126), 1);
}
